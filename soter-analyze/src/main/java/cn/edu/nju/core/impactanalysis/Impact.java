package cn.edu.nju.core.impactanalysis;
    ...
    public void calculateImpactPercenje() {
        ...
        for (StereotypeIdentifier identifier : identifiers) {
            ...
            if (identifier.getRelatedTypes() != null) {
                ...
                identifier.setImpactPercentage((methods / getTotal()) * 100);
            } else {
                identifier.setImpactPercentage(0d);
            }
            total += identifier.getImpactPercentage();
            System.out.println("Impact (" + methods + " / " + getTotal() + ")" + identifier.getCompilationUnit().getElementName() + ": " + identifier.getImpactPercentage());
        }
