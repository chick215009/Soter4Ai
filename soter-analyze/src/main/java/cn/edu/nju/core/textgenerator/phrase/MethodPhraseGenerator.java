...
import cn.edu.nju.core.textgenerator.pos.Tag;
...
public class MethodPhraseGenerator implements PhraseGenerator {
    ...
    @SuppressWarnings("unchecked")
    private void generateSimpleDescription() throws IOException, ClassNotFoundException {
...
//        System.out.println("METHOD: " + returnType + " " + methodName + "(" + MethodPhraseUtils.getMethodParamsString(getMethod().parameters()) + ") "  + " PHRASE: " + phrase.toString());
    ...
    private LinkedList<TaggedTerm> getTaggedText(String phrase) throws IOException, ClassNotFoundException {
