...
public class StructureDiffNode {
    ...
    public StructureDiffNode() {
        ...
        fDiffType = StructureDifferencer.DiffType.NO_CHANGE;
    }
    ...
    public void setDiffType(StructureDifferencer.DiffType type) {
        fDiffType = type;
    }
    ...
    public boolean isChanged() {
        return !(fDiffType == StructureDifferencer.DiffType.NO_CHANGE);
    }
    ...
    public boolean isAddition() {
        return fDiffType == StructureDifferencer.DiffType.ADDITION;
    }

    public boolean isDeletion() {
        return fDiffType == StructureDifferencer.DiffType.DELETION;
    }
