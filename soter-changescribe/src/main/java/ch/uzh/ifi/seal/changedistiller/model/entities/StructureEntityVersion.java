...
public class StructureEntityVersion {
     ...
     */
    public StructureEntityVersion(EntityType type, String uniqueName, int modifiers, String version, JavaStructureNode javaStructureNode) {
        this();
        setType(type);
     ...
     *            the modifiers
     */
    public StructureEntityVersion(EntityType type, String uniqueName, int modifiers, JavaStructureNode javaStructureNode) {
        this();
        setType(type);
        setUniqueName(uniqueName);
        setModifiers(modifiers);
