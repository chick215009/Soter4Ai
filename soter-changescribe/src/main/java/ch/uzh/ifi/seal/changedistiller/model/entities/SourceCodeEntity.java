...
public class SourceCodeEntity {
     ...
     *            the range
     */
    public SourceCodeEntity(String uniqueName, EntityType type, SourceRange range, ASTNode node, String name, JavaStructureNode javaStructureNode) {
        this(uniqueName, type, 0, range, node, name, javaStructureNode);
    }
     ...
     *            the range
     */
    public SourceCodeEntity(String uniqueName, EntityType type, int modifiers, SourceRange range, ASTNode node,  String name, JavaStructureNode javaStructureNode) {
        setUniqueName(uniqueName);
        setType(type);
