...
import cn.edu.nju.changescribe.domain.vo.FilterVo;
import cn.edu.nju.core.filter.*;
import cn.edu.nju.changescribe.service.CodeDiffService;
import cn.edu.nju.changescribe.service.CommitService;
import cn.edu.nju.changescribe.service.FileService;
import cn.edu.nju.changescribe.service.GitService;
...
public class PanelController {
    ...
    public String generateCommitMessage2(@RequestBody FilterVo filterVo) throws IOException, ClassNotFoundException, GitAPIException {
//        return commitService.generateCommitMessage(projectPath);
    ...
    public AnalyzeResultVO generateCommitMessage3(@RequestBody FilterVo filterVo) throws IOException, ClassNotFoundException, GitAPIException {
//        return commitService.generateCommitMessage(projectPath);
        String projectPath = filterVo.getProjectPath();
        String newProjectPath = filterVo.getNewProjectPath();
        SimpleDescribeFilter simpleDescribeFilter = new SimpleDescribeFilter(filterVo.getIsSimpleDescribe());
...
//        fileService.updateProject(projectPath, newProjectPath);
    ...
    public String generateCommitMessage4(@RequestParam("projecPath") String projectPath,
                                         @RequestParam("newProjectPath") String newProjectPath) throws IOException, ClassNotFoundException {
//        return commitService.generateCommitMessage(projectPath);
